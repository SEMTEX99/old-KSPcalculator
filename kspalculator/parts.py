...
RocketFuelTanks = [
        FuelTank('Oscar-B', RadialSize.Tiny, 70, 225),               
        FuelTank('FL-T100', RadialSize.Small, 150, 562.5),           
        FuelTank('FL-T200', RadialSize.Small, 275, 1125),
        FuelTank('FL-T400', RadialSize.Small, 500, 2250),
        FuelTank('FL-T800', RadialSize.Small, 800, 4500),            
        FuelTank('X200-8',  RadialSize.Large, 800, 4500),            
        FuelTank('X200-16', RadialSize.Large, 1550, 9000),
        FuelTank('X200-32', RadialSize.Large, 3000, 18000),
        FuelTank('Jumbo-64',RadialSize.Large, 5750, 36000),          
        FuelTank('S3-3600', RadialSize.ExtraLarge, 3250, 20250),     
        FuelTank('S3-7200', RadialSize.ExtraLarge, 6500, 40500),
        FuelTank('S3-14400',RadialSize.ExtraLarge, 13000, 81000) ]   
...
RadialstageExtraTech = ResearchNode.Stability 